...
```hcl
module "vpc-peering" {
  source           = "git::https://github.com/sohanyadav/terraform-aws-vpc-peering.git?ref=v1.0.0"
  name             = local.name
...
## Examples
For detailed examples on how to use this module, please refer to the [examples](https://github.com/sohanyadav/terraform-aws-vpc-peering/tree/master/_example) directory within this repository.

## License
This Terraform module is provided under the '[License Name]' License. Please see the [LICENSE](https://github.com/sohanyadav/terraform-aws-vpc-peering/blob/master/LICENSE) file for more details.
...
| <a name="input_repository"></a> [repository](#input\_repository) | Terraform current module repo | `string` | `"https://github.com/sohanyadav/terraform-aws-vpc-peering"` | no |
